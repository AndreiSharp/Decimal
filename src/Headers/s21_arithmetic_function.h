...
bit32_t s21_add(s21_decimal value_1, s21_decimal value_2, s21_decimal *result);

bit32_t s21_sub(s21_decimal value_1, s21_decimal value_2, s21_decimal *result);

bit32_t s21_mul(s21_decimal value_1, s21_decimal value_2, s21_decimal *result);

bit32_t s21_div(s21_decimal value_1, s21_decimal value_2, s21_decimal *result);
