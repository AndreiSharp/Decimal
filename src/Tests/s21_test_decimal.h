...
#define TEST_ADD 1
#define TEST_DIV 0
#define TEST_IS_EQUAL 1
#define TEST_IS_NOT_EQUAL 1
#define TEST_IS_LESS 1
#define TEST_IS_LESS_OR_EQUAL 1
#define TEST_IS_GREATER 1
#define TEST_IS_GREATER_OR_EQUAL 1
