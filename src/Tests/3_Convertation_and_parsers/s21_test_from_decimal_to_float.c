...
START_TEST(test_s21_from_decimal_to_float6) {
  s21_decimal decimal;
  decimal = s21_decimal_null();
  decimal = s21_decimal_invert(decimal, COUNT_BLOCKS_MANTIS);
  decimal = s21_decimal_set_scale(decimal, 18);
...
Suite *test_s21_from_decimal_to_float_suite() {
  ...
  tcase_add_test(tc_core, test_s21_from_decimal_to_float6);
