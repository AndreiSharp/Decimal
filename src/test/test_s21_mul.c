...
START_TEST(test_s21_mul_2) {
  ...
  s21_decimal decimal_required = {{600, 0, 0, 0b10000000000000000000000000000000}};
  s21_decimal *result;
  int status = s21_mul(decimal_first, decimal_second, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
...
START_TEST(test_s21_mul_3) {
  ...
  s21_decimal decimal_second = {{37865, 0, 0, 0b10000000000000000000000000000000}};
...
START_TEST(test_s21_mul_5) {
  ...
  s21_decimal decimal_required = {{0b11111111111111111111111111111111, 0b11111111111111111111111111111111, 0b11111111111111111111111111111111, 0}};
  s21_decimal *result;
  int status = s21_mul(decimal_first, decimal_second, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
...
START_TEST(test_s21_mul_6) {
  ...
  s21_decimal decimal_required = {{1, 0, 0, 0b00000000000111000000000000000000}};
  s21_decimal *result;
  int status = s21_mul(decimal_first, decimal_second, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
...
START_TEST(test_s21_mul_7) {
  s21_decimal decimal_first = {{53785, 0, 0, 0b00000000000000110000000000000000}};
  s21_decimal decimal_second = {{1, 0, 0, 0}};
  s21_decimal decimal_required = {{53785, 0, 0, 0b00000000000000110000000000000000}};
  s21_decimal *result;
  int status = s21_mul(decimal_first, decimal_second, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
...
START_TEST(test_s21_mul_8) {
  s21_decimal decimal_first = {{8511, 0, 0, 0b00000000000000100000000000000000}};
  s21_decimal decimal_second = {{324, 0, 0, 0b00000000000000100000000000000000}};
  s21_decimal decimal_required = {{2757564, 0, 0, 0b00000000000001000000000000000000}};
  s21_decimal *result;
  int status = s21_mul(decimal_first, decimal_second, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
