...
START_TEST(test_s21_floor_4) {
  ...
  s21_decimal decimal_required = {{1, 0, 0, 0b10000000000000000000000000000000}};  
  s21_decimal *result;
  int status = s21_floor(decimal, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
...
START_TEST(test_s21_floor_5) {
  ...
  s21_decimal decimal_required = {{95, 0, 0, 0b00000000000000000000000000000000}};  
  s21_decimal *result;
  int status = s21_floor(decimal, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
...
START_TEST(test_s21_floor_6) {
  ...
  s21_decimal decimal_required = {{96, 0, 0, 0b10000000000000000000000000000000}};  
  s21_decimal *result;
  int status = s21_floor(decimal, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
...
START_TEST(test_s21_floor_7) {
  s21_decimal decimal = {{58490938, 0b11111111111111111111111111111111, 0, 0b00000000000001110000000000000000}};
  s21_decimal decimal_required = {{5, 0b11111111111111111111111111111111, 0, 0b00000000000000000000000000000000}};  
  s21_decimal *result;
  int status = s21_floor(decimal, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
