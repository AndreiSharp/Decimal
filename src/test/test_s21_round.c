...
START_TEST(test_s21_round_5) {
  ...
  s21_decimal decimal_required = {{74, 0, 0, 0b00000000000000000000000000000000}};  
  s21_decimal *result;
  int status = s21_round(decimal, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
...
START_TEST(test_s21_round_6) {
  s21_decimal decimal = {{61490752, 0b11111111111111111111111111111111, 0, 0b00000000000001110000000000000000}};
  s21_decimal decimal_required = {{6, 0b11111111111111111111111111111111, 0, 0b00000000000000000000000000000000}};  
  s21_decimal *result;
  int status = s21_round(decimal, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
...
START_TEST(test_s21_round_7) {
  s21_decimal decimal = {{80000000, 0b11111111111111111111111111111111, 0b00000000000000000000000000000011, 0b00000000000001110000000000000000}};
  s21_decimal decimal_required = {{8, 0b11111111111111111111111111111111, 0b00000000000000000000000000000011, 0b00000000000000000000000000000000}};  
  s21_decimal *result;
  int status = s21_round(decimal, result);
  ck_assert_int_eq(s21_is_equal(*result, decimal_required), 1);
  ck_assert_int_eq(status, S21_SUCCES);
