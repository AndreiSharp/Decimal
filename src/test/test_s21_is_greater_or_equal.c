...
START_TEST(test_s21_is_greater_or_equal_1) {
    ...
    int result_s21_is_greater_or_equal = s21_is_greater_or_equal(decimal_1, decimal_2);
    ck_assert_int_eq(result_s21_is_greater_or_equal, S21_TRUE);
}
END_TEST
...
START_TEST(test_s21_is_greater_or_equal_2) {
    ...
    int result_s21_is_greater_or_equal = s21_is_greater_or_equal(decimal_1, decimal_2);
    ck_assert_int_eq(result_s21_is_greater_or_equal, S21_FALSE);
}
END_TEST
...
Suite *test_s21_is_greater_or_equal_suite() {
    ...
    TCase *tc_core = tcase_create("core_of_s21_is_greater_or_equal");
