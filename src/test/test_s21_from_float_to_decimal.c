...
START_TEST(test_s21_from_float_to_decimal_18) {
  // тест 18
   s21_decimal dst;
  float src = 0.00000000000000000000000000009999998226151445646676901231373326364778153626990814f;
  int result = s21_from_float_to_decimal(src, &dst);
  ck_assert_int_eq(result, S21_FALSE);
}
END_TEST
...
START_TEST(test_s21_from_float_to_decimal_19) {
  // тест 19
   s21_decimal dst;
  float src = 4.8148245739821641389174087312824996385704304343408247917894169330688125540973487659357488E-35f;
  int result = s21_from_float_to_decimal(src, &dst);
  ck_assert_int_eq(result, S21_FALSE);
}
END_TEST
...
START_TEST(test_s21_from_float_to_decimal_20) {
  // тест 20
   s21_decimal dst;
  float src = 1.2621774483536188886587657044524579674771302961744368076324462890625E-29f;
  int result = s21_from_float_to_decimal(src, &dst);
  ck_assert_int_eq(result, S21_FALSE);
}
END_TEST
